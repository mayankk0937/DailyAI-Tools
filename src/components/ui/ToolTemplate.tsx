  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-[calc(100vh-180px)] min-h-[600px]">
        {/* Input Column */}
        <div className="glass p-6 rounded-2xl border border-white/5 flex flex-col h-full overflow-hidden">
        ...
        {/* Output Column */}
        <div className="glass p-6 rounded-2xl border border-white/5 flex flex-col h-full relative overflow-hidden bg-gradient-to-b from-transparent to-primary/5">
          ...
          <div className="flex-1 bg-black/50 rounded-xl border border-white/5 p-4 overflow-y-auto relative custom-scrollbar">
            {isGenerating && (
