        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link href="/tools/resume-maker" className="hover:text-primary transition-colors">Resume Maker</Link></li>
              <li><Link href="/tools/caption-generator" className="hover:text-primary transition-colors">Caption Generator</Link></li>
              <li><Link href="/tools/pdf-summarizer" className="hover:text-primary transition-colors">PDF Summarizer</Link></li>
              <li><Link href="/tools/study-planner" className="hover:text-primary transition-colors">Study Planner</Link></li>
              <li><Link href="/tools/youtube-notes" className="hover:text-primary transition-colors">YouTube to Notes</Link></li>
            </ul>
          </div>
